<?php
	...
	{
	$sql="delete from seminar_wp where email='$email' and category='$category' and topic='$aname'";
	...
	if($res)
	{
		...
		alertify.alert('Record deleted successfully', function (e) {
	...
	{
	$sql="delete from technical_paper where email='$email' and category='$category' and papername='$aname'";
	$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");
	...
	{
	$sql="delete from technical_ds where email='$email' and category='$category' and ename='$aname'";
	$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");
	...
	{
	$sql="delete from work_exp where email='$email' and category='$category' and co_name='$aname'";
	$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");
	...
	{
	$sql="delete from certification where email='$email' and category='$category' and cname='$aname'";
	$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");
	...
	if($category=='Sports')
	{
	$sql="delete from sports where email='$email' and category='$category' and sportsname='$aname'";
	$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");
...
<fieldset style="width:600">
		...
		<form name="create" method="POST" action="update.php" onsubmit="return validateAll()" enctype="multipart/form-data">			
                    <tr align='left'>
					...
					<td><input  type="text" class="text2" name="topicname" id="input-topicname" value="<?php echo $row['topic'] ?>" temp="Please enter the topic name." onblur="validate(this)" /><br>
					...
					<td><input  type="text" class="text2" name="year1" id="input-year1" value="<?php echo $row['year'] ?>" temp="Year should be in range 1960 to current year" onblur="numberValidator(this)" /><br>
					...
					<option value="<?php echo $row['member'] ?>"><?php echo $row['member'] ?></option>
					...
					<td><textarea name='description' id='input-description'  class='text2' temp="Please enter description." onblur="validate1(this)"><?php echo $row['description'] ?></textarea><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Topic Name:</strong></label></td>
					<td><input  type="text" class="text2" name="topicname1" id="input-topicname1" value="<?php echo $row['topic'] ?>" temp="Please enter the topic name." onblur="validate(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Year:</strong></label></td>
					<td><input  type="text" class="text2" name="year2" id="input-year2" value="<?php echo $row['year'] ?>" temp="Year should be in range 1960 to current year" onblur="numberValidator(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Description:</strong></label></td>
					<td><textarea name='description1' id='input-description1'  class='text2' temp="Please enter description." onblur="validate1(this)"><?php echo $row['description'] ?></textarea><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Topic Name:</strong></label></td>
					<td><input  type="text" class="text2" name="topicname2" id="input-topicname2" value="<?php echo $row['topic'] ?>" temp="Please enter the topic name." onblur="validate(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Year:</strong></label></td>
					<td><input  type="text" class="text2" name="year3" id="input-year3" value="<?php echo $row['year'] ?>" temp="Year should be in range 1960 to current year" onblur="numberValidator(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Description:</strong></label></td>
					<td><textarea name='description2' id='input-description2'  class='text2' temp="Please enter description." onblur="validate1(this)"><?php echo $row['description'] ?></textarea><br>
					...
					<td><input  type="text" class="text2" name="papername" id="input-papername" value="<?php  echo $row['papername'] ?>" temp="Please enter the paper name." onblur="validate(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Year:</strong></label></td>
					<td><input  type="text" class="text2" name="year4" id="input-year4" value="<?php  echo $row['year'] ?>" temp="Year should be in range 1960 to current year" onblur="numberValidator(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Description:</strong></label></td>
					<td><textarea name='description3' id='input-description3'  class='text2' temp="Please enter description." onblur="validate1(this)"><?php echo $row['description'] ?></textarea><br>
					...
					<td><input  type="text" class="text2" name="eventname" id="input-eventname" value="<?php echo $row['ename'] ?>" temp="Please enter the event name." onblur="validate(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Year:</strong></label></td>
					<td><input  type="text" class="text2" name="year5" id="input-year5" value="<?php echo $row['year'] ?>" temp="Year should be in range 1960 to current year" onblur="numberValidator(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Description:</strong></label></td>
					<td><textarea name='description4' id='input-description4'  class='text2' temp="Please enter description." onblur="validate1(this)"><?php echo $row['description'] ?></textarea><br>
					...
					<option value="<?php echo $row['award'] ?>"><?php echo $row['award'] ?></option>
					<option value="Select">Select</option>
					...
					<td><input  type="text" class="text2" name="orgname" id="input-orgname" value="<?php echo $row['co_name'] ?>" temp="Please enter the organisation name." onblur="validate(this)" /><br>
					...
					<td><input  type="text" class="text2" name="experience" id="input-experience" value="<?php echo $row['exp'] ?>" temp="Please enter the experience in months between 0 to 100." onblur="numberValidator(this)" /><br>
					...
					<td><textarea name='designation' id='input-designation'  class='text2' value="<?php echo $row['designation'] ?>" temp="Please enter designation." onblur="validate1(this)"></textarea><br>
					...
					<td><input  type="text" class="text2" name="coursename" id="input-coursename" value="<?php echo $row['cname'] ?>" temp="Please enter the course name." onblur="validate(this)" /><br>
					...
					<td><input  type="text" class="text2" name="module" id="input-module" value="<?php echo $row['module'] ?>" temp="Please enter the module." onblur="validate1(this)" /><br>
					...
					<td><input  type="text" class="text2" name="score" id="input-score" value="<?php echo $row['score'] ?>" temp="Please enter the score." onblur="numberValidator(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Year:</strong></label></td>
					<td><input  type="text" class="text2" name="year6" id="input-year6" value="<?php echo $row['year'] ?>" temp="Year should be in range 1960 to current year" onblur="numberValidator1(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Description:</strong></label></td>
					<td><textarea name='description5' id='input-description5'  class='text2' temp="Please enter description." onblur="validate2(this)"><?php echo $row['description'] ?></textarea><br>
					...
					<td><input  type="text" class="text2" name="sportname" id="input-sportname" value="<?php echo $row['sportsname'] ?>" temp="Please enter the sport name." onblur="validate(this)" /><br>
					...
					<tr>
					<td><label><span style='color:red;'>*</span><strong>Year:</strong></label></td>
					<td><input  type="text" class="text2" name="year" id="input-year" value="<?php echo $row['year'] ?>" temp="Year should be in range 1960 to current year" onblur="numberValidator(this)" /><br>
					...
					<option value="<?php echo $row['playedas'] ?>"><?php echo $row['playedas'] ?></option>
					<option value="Select">Select</option>
