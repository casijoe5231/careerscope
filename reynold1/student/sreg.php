...
<div id="controlBoard">
<form action="scheck.php" onsubmit="return validateAll()" method="post">
			...
			<fieldset id="fieldset"style="border-radius:5px;">
				...
				<label><span style="color:red;">*</span>Semester:</label><br />
				<input type="text" class="text2" name="sem" id="input-sem"  temp="Enter valid semester" onblur="numberValidator1(this)" /><br />
				<label ><span id="sem" style="color:#C00;"></span></label><br />
...
<p><a href='slogin.php' style='color:blue;text-transform:none;text-decoration:none;'>&lt;&lt;&nbsp;PREVIOUS PAGE</a></p>
