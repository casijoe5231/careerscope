...
<div id='container_internal'>
  ...
  <p> Your Name:
    ...
    <div>
    <input type='text' name='email' id='email' class='animated' style="width:100%;">
    </div>
    </p>
	<p>Education Details:
    ...
    <p>Skills:
    <div id='skill_error' class='error'><img src='../images/error.png'>Please fill in your skills.</div>
    <div>
    ...
    <div id='mail_success' class='success'><img src='../images/success.png'>Your Profile has been created successfully.</div>
...
<p><a href='view.php'>RETURN TO PREVIOUS PAGE</a></p>
