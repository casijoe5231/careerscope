...
$sql="insert into masteruser(email,password,name,year,mobile,role,discipline,institute,status) values('$email','$password','$name','".date('Y')."','$phone','Alumni','$discipline1','$institute1',0)";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");

$sql="insert into ialumni(email,gender,dob,address,year,branch,company,title,experience,expertype,area,enrollstatus,paymentstatus) values('$email1','$gender','$date','$address','$year1','$branch','$company','$title','$experience','$expertype','$area',0,0)";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");
