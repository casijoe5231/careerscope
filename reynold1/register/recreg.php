...
$sql="insert into masteruser(email,password,name,year,mobile,role,discipline,institute,status) values('$email','$password','$name','".date('Y')."','$phone','Recruiter','$discipline3','$institute3',0)";
...
*/
	...
	if($res)
	{
		...
		<link rel='stylesheet' href='../css/alertify.default.css' /></head></html>";
		echo "<SCRIPT LANGUAGE='JavaScript'>
		alertify.alert('You have registered successfully.An email is sent to the TPO.Please login', function (e) {
		window.location.href='../login.php';
		});</SCRIPT>";
	}
	else
