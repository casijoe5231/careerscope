...
$sql="insert into masteruser(email,password,name,year,mobile,role,discipline,institute,status) values('$_SESSION[email]','$password','$name','".date('Y')."','$phone','Guest','$discipline5','none',0)";
