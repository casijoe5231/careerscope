...
xmlhttp.open("GET","post.php?q="+str,true);
xmlhttp.send();
}
</script>
</head>
...
<center>";
echo "<p>Company Name:";
echo "<select name='name' onchange='show(this.value)'>";
...
<form name='contactForm' id='contact_form' method='post' action='update.php'>
  <p> Company Name:
    ...
    <div>
    <textarea name='profile' rows='2' cols='60' class='animated'>".$row['profile']."</textarea> 
    </div>
    </p>
	<p>Job Title:
