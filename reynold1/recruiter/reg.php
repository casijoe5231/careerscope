...
<form action="rcheck.php" onsubmit="return validateAll()" method="post">
			...
			<fieldset id="fieldset"style="border-radius:5px;">
				...
				<input  type="text" class="text2" name="fname" id="input-fname" autofocus placeholder="Please enter your name" temp="Please enter your name." onblur="validate(this)" /><br />
...
<p><a href='rlogin.php' style='color:blue;text-transform:none;text-decoration:none;'>&lt;&lt;&nbsp;PREVIOUS PAGE</a></p>
