...
</head><body onLoad="MM_preloadImages('images/logo_quant_l.png, images/logo_verbal_l.png, images/logo_logical_l.png','images/logo_technical_l.png')">
<div class="bg">
<div class="container">
<?php
header_fn();
...
<a href="select.php" style="border:1px solid #09F; background:#09F; padding:8px; color:#FFF;  border-radius:5px; font-size:16px; text-align:center; margin-right:1%;">View all Tests</a>
</div>
<br><br><br>
</div>
