...
include '../connection.php';
    ...
    echo "<tr><th>First Name</th> <th>Last Name</th> <th>Username</th> <th>Authorized</th> <th>Access Type</th> <th>Edit</th> <th>Delete</th></tr>";
		while($row = mysqli_fetch_array($res))
		{
			...
			echo "</td>";
			echo "<td>".$row['type']."</td>";
			echo "<td><div id='basic-modal'><a href='#' class='basic' onClick=\"setCookie('user_id','".$row['s_username']."',1)\"><input type='image' src='../images/edit2.png'  width='25px;'name='edit_question'></a></div></td>";
