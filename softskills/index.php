...
<!--  Welcome Bar  -->
        <nav style="padding: 0 8px 0 8px;" class="navbar-container">
            ...
            <li style="padding: 0 8px 0 8px;"><a id="loginbutton" href="questionform.php" style="padding: 6px 12px;" class="btn btn-md btn-default">
                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"> </span> Add Questions
                    
                    </a>
                </li>
                <li style="padding: 0 8px 0 8px;"><a id="loginbutton" value="Chat with mentors"   style="padding: 6px 12px;" class="btn btn-md btn-default">
  ...
  <div class="panel-group" id="accordion">
    <div class="panel panel-default"><!-- first skill-->
      ...
      <div id="collapse1" class="panel-collapse collapse">
		...
		<li><a style="font:icon" href="leadertest1.php">Take the Test</a></li></ul>
		</div>
      </div>
    </div><!-- first skill-->
    <div class="panel panel-default"><!-- 2 skill-->
      ...
      <div id="collapse2" class="panel-collapse collapse">
        ...
        <li><a style="font:icon" href="timetest.php">Take the Test</a></li></ul></div>
      </div>
    </div><!-- 2 skill-->
    <div class="panel panel-default"><!-- 3 skill-->
      <div class="panel-heading">
        <h4 class="panel-title">
      ...
      <div id="collapse3" class="panel-collapse collapse">
        <div class="panel-body"><ul style="list-style-type:none"><li><a style="font:icon" href="Stress.php" >Know your Stress</a></li><li><a style="font:icon" href="#">Test Yout Stress</a></li></ul></div>
      </div>
    </div><!-- 3 skill-->
    
    <div class="panel panel-default"><!-- 4 skill-->
      <div class="panel-heading">
        <h4 class="panel-title">
      ...
      <div id="collapse4" class="panel-collapse collapse">
        <div class="panel-body"><ul style="list-style-type:none"><li><a style="font:icon" href="#" >Art of Speaking</a>
     <ul><li><a style="font:icon" href="#"> Speak to motivate</li><li><a style="font:icon" href="#">Take the Test</li>
     </ul>        
        </li>
        <li><a style="font:icon" href="#">Art of Writing</a><ul><li><a style="font:icon" href="#"> Write to Excel</li>
        <li><a style="font:icon" href="#">Take the Test</li>
     </ul> </li>
        
        </ul></div>
      </div>
    </div><!-- 4 skill-->
    <div class="panel panel-default"><!-- 5 skill-->
      <div class="panel-heading">
        <h4 class="panel-title">
      ...
      <div id="collapse5" class="panel-collapse collapse">
        <div class="panel-body"><ul style="list-style-type:none"><li><a style="font:icon" href="#" >Change is here to Happen</a></li>
        <li><a style="font:icon" href="#">Test You Stress</a></li></ul></div>
      </div>
    </div><!-- 5 skill-->
        <div class="panel panel-default"><!-- 6 skill-->
      <div class="panel-heading">
        <h4 class="panel-title">
     ...
     <ul><li><a style="font:icon" href="#">Stand to impress</li><li><a style="font:icon" href="#">Take the Test</li>
     </ul>        
        </li>
        <li><a style="font:icon" href="#">Etiquette and Manners</a><ul><li><a style="font:icon" href="#">Know What</li>
        <li><a style="font:icon" href="#">Take the Test</li>
     </ul> </li>
