...
<!--/form-->
        ...
        <div class="col-sm-12 ">
<form class="form-horizontal" role="form" action="softskillquestions.php" onsubmit="return validateAll()" method="post">
            <div class="well">
<!--Section One--><h2>Soft-Skill Questions</h2>
           ...
           <div class="col-sm-8">
                <select class="form-control"  name="t_id" id="input-discipline" temp="Please select the discipline" onblur="validator(this)">
                    ...
                    <option value="159">Leadership Skill</option>
                    <option value="60">Time Management</option>
                    <option value="33">Stress Management</option>
                    <option value="35">Communication Skill</option>
                    <option value="57">Change Management</option>
                    <option value="58">Image Management</option>
...
$qid="select q_id from softskillquestions  where t_id='$type'";
...
$sql="INSERT INTO softskillquestions(t_id,q_id,questions)
VALUES (".$type.", ".$count.", '".$question."')";
