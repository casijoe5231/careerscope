            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
                            <form class="form-horizontal" action="ebrand.php"  method="get">
...
<input class="btn btn-primary pull-right" type="submit" id="submit" name="submit" style="cursor:pointer;" value="Submit">
                                        </div>
                                    </div>
                                </div>
                                </form>
