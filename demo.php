            ...
            <div class="col-md-11">
                <div class="mast-nav" style="text-align: center;">
                    <ul id="menu" style="color: red;" >
                        ...
                        <li class="active"><a href="demo.php">Assign Task</a>
                        </li>
...
<h4>Computer Science</h4>
    	<a id="displayText" href="javascript:toggle();">First Year</a><br>
		<a id="displayText" href="javascript:toggle1();">Second Year</a><br>
		<a id="displayText" href="javascript:toggle2();">Third Year</a><br>
		


<a id="displayText" href="javascript:toggle3();">BE</a> 
<div id="toggleText" style="display: none">
        ...
        echo $res1=mysqli_query($GLOBALS["___mysqli_ston"], $sql1);
      ...
      <!--  <input type="hidden" name="Director[]" value="ERP">-->
       ...
       <!-- <input type="hidden" name="Director[]" value="IP">-->
		...
		<td>
		<div class="col-sm-8">
			<select class="form-control"  name="sem" id="input-year" temp="Please select the year" onblur="validator(this)">
