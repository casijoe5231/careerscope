...
$count=mysqli_num_rows($res1);
	if($count)
	{
		...
		{
  echo '<tr><th scope="row">'.$row1['goal_id'].'</th><td>'.$row1['title'].'</td><td>'.$row1['goal_type'].'</td><td>'.$row1['date_created'].'</td><td>'.$row1['deadline'].'</td><td><a href="file_view_self.php?id='.$row1['goal_id'].'"" class="btn btn-default" role="button" data-toggle="modal" title="View Goal '.$row1['title'].'" data-target="#myModal_View"><small>View Details</small></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="eval_report.php?id='.$row1['goal_id'].'" class="btn btn-info" role="button" target="_blank" title="View Weekly Reports Submitted for '.$row1['title'].'" role="button">View Reports Submitted</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="evaluate_self.php?id='.$row1['goal_id'].'" class="btn btn-success" role="button" title="Evaluate Goal '.$row1['title'].'" role="button">Self Evaluate</a></td>
  <td>
