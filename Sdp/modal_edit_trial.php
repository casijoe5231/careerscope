...
<link href="images/favicon.ico" rel="shortcut icon"/>
    ...
    <title>EYB | SDP -Edit Schedule Trial</title>
...
<!-- Name of user ends-->
<?php ?>
<!--Experiment with Edit and View Data in Modal-->
<td><span data-placement="top" data-toggle="tooltip" title="View"><a class="btn btn-primary btn-md" data-toggle="modal" data-target="#editBox" href="file.php?id=<?php echo 'hello';?>"><span class="glyphicon glyphicon-pencil"></span></a></span></td>
<?php
//echo "hi";
//echo '$obj->id';
?>
<div class="modal fade" id="editBox" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <h2>//Content Will show Here</h2>
        </div>
    </div>
</div>
<!--Experiment with Edit and View Data in Modal Ends here-->
