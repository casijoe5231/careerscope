...
$sql1="select * from goal_dead where email='$email'and goal_id='$Id'";
...
<div class="modal-footer">
   <!-- <button type="button" class="btn btn-default">Submit</button>-->
    <button type="button" onclick="location.href='sdp_dead.php'" class="btn btn-danger" data-dismiss="modal">Close</button>
