...
$sql4="insert into goal_measurable (goal_id,email,title,date_eval,percent_goal,improvements,m_goalcom,goal_success,justify,ontime,future,user_score,sys_score,system_comment)values('$goal_id','$email','$row1[title]','$time_added','$value5','$improvements','$value7','$value8','$justify','$yesno','$future','$user_score','$sys_score','$comment')";
