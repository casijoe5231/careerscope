...
$mscore=0;
$mscore = $yesno+$exact+$time+$regular+$manage;
...
$sql4="insert into goalm_timebased (goal_id,title,stud_name,stud_email,mentor_name,mentor_email,date_eval,yesno,exact,time,regular,manage,feedback,mscore)values('$goal_id','$row1[title]','$row00[stud_name]','$row1[email]','$user','$email','$time_added','$yesno','$exact','$time','$regular','$manage','$feedback','$mscore')";
