...
<div class="panel panel-primary">
	  ...
	  <strong>Number of Reports Submitted:</strong> <?php echo $data2[no_weekly_updates]?> <br>
	  <strong>Deadline:</strong> <?php echo $data2[deadline]?> <br>
	  <strong>Goal Achieved On:</strong> <?php echo $data2[date_completed]?> <br>
	  </div> 
   
</div>
<div class="modal-footer">
   <!-- <button type="button" class="btn btn-default">Submit</button>-->
    <button type="button" onclick="location.href='sdp_evidence.php'" class="btn btn-danger" data-dismiss="modal">Close</button>
