...
<link href="images/favicon.ico" rel="shortcut icon"/>
    ...
    <title>EYB | View Evaluated Goals</title>
...
<div class="panel panel-primary panel-transparent">
  <div class="panel-heading">
    <center><h3 class="panel-title">Goals Evaluated by Self & Mentor</h3></center>
  </div>
...
$count=mysqli_num_rows($res1);
	...
	if($count)
	{
		...
		{
				$goal_t = str_replace(' ','',$row1[goal_type]);
				echo '<div class="col-md-4"><div class="thumbnail"><img src="..." alt=""><div class="caption"><h3>'.$row1['title'].'</h3><p>Date Created: '.$row1['date_created'].'</p><p>Goal_id: '.$row1['goal_id'].'</p><p><a href="filevieweval.php?id='.$row1['goal_id'].'"" class="btn btn-default" role="button" data-toggle="modal" data-target="#myModal_View">Details</a><a href="sys_feedback.php?id='.$row1['goal_id'].'&type='.$goal_t.'"" class="btn btn-default" role="button" data-toggle="modal" data-target="#myModal_View2">Self Score & System Feedback</a><a href="mscore_view.php?id='.$row1['goal_id'].'&type='.$goal_t.'"" class="btn btn-default" role="button" data-toggle="modal" data-target="#myModal_View3">Mentor Score</a></p></div></div></div>';
//echo "hi";
...
//echo $row1['goal_id'];       
	...
	{
		echo '<h2>No Goals Evaluated Yet</h2>';
...
<div class="modal fade" id="myModal_View2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<div class="modal fade" id="myModal_View3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
