...
<center><h3>Select a Goal to add your Documents</h3></center>
<center>
...
$count=mysqli_num_rows($res1);
	...
	if($count)
	{
		...
		{
				echo '<div class="col-md-4"><div class="thumbnail"><img src="..." alt=""><div class="caption"><h3>'.$row1['title'].'</h3><p>Achieved On: '.$row1['date_completed'].'</p><p>Goal_id: '.$row1['goal_id'].'</p><p><a href="file_cert_upload.php?id='.$row1['goal_id'].'" class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal_Add">Upload Completion Certificate</a> <a href="fileview_completion.php?id='.$row1['goal_id'].'"" class="btn btn-default" role="button" data-toggle="modal" data-target="#myModal_View">View</a></p></div></div></div>';
//echo "hi";
