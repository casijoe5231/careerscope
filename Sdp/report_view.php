...
<div class="modal-header">
    ...
    <h4 class="modal-title"><center><?php $user_name = $_SESSION['user'][1]; echo "$user_name"; echo "'s Report for $data2[title]";?></center></h4>
</div>
...
<div class="modal-footer">
   <!-- <button type="button" class="btn btn-default">Submit</button>-->
    <button type="button" onclick="location.href='eval_report.php'" class="btn btn-danger" data-dismiss="modal">Close</button>
