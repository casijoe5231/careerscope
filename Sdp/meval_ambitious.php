...
$mscore = $yesno+$gap+$skill+$challenge+$project+$enter+$study;
...
$sql4="insert into goalm_ambitious (goal_id,title,stud_name,stud_email,mentor_name,mentor_email,date_eval,yesno,gap,skill,challenge,project,enter,study,feedback,mscore)values('$goal_id','$row1[title]','$row00[stud_name]','$row1[email]','$user','$email','$time_added','$yesno','$gap','$skill','$challenge','$project','$enter','$study','$feedback','$mscore')";
