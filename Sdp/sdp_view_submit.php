...
<div class="panel panel-primary">
  ...
  ?>
  <div class="panel-heading"><center><h4><?php echo "$user_name";echo "'s Submitted Certificates for $row3[title]"; ?></h4></center></div>
...
$count=mysqli_num_rows($res2);
	if($count)
	{
		...
		{ ?>
			<tr><th scope="row"><?php echo $row2['file_name']; ?> </th><td><?php echo $row2['file_type']; ?> </td><td><?php echo $row2['file_size']; ?></td><td><?php echo $row2['date_sub']; ?></td><td><a target="_blank" href="http://localhost/careerscope/Sdp/uploads/<?php echo $user_name; ?>/<?php echo $row2['file_name'];?>"><img alt="View File" src="/var/www/html/careerscope/Sdp/uploads/<?php echo $user_name; ?>/<?php echo $row2['file_name'];?>"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo '<a href="sdp_del_evid.php?evid='.$row2['evidence_id'].'&id='.$Id.'" class="btn btn-danger" role="button" data-toggle="modal" data-target="#myModal_Edit" title="Delete Goal '.$row2['file_type'].'" role="button"><small>Delete</small></a></td></tr>';?>
	<?php	}
	}
	else
	{
