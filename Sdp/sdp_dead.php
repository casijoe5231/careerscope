...
<link href="images/favicon.ico" rel="shortcut icon"/>
    ...
    <title>EYB | SDP -Goal Revive</title>
...
<div class="panel panel-primary">
  ...
  <div class="panel-heading"><h4><center><?php $user_name = $_SESSION['user'][1]; echo "$user_name";echo "'s  Dead Goals" ?></center></h4></div>
...
$sql1="select * from goal_dead where email='$email'";
...
$count=mysqli_num_rows($res1);
	if($count)
	{
		...
		{
			echo '<tr><th scope="row">'.$row1['goal_id'].'</th><td>'.$row1['title'].'</td><td>'.$row1['goal_type'].'</td><td>'.$row1['time_added'].'</td><td>'.$row1['deadline'].'</td><td><a href="sdp_dead_view.php?id='.$row1['goal_id'].'"" class="btn btn-default" role="button" data-toggle="modal" title="View Goal '.$row1['title'].'" data-target="#myModal_View"><small>View</small></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="sdp_revive_goal.php?id='.$row1['goal_id'].'" class="btn btn-success" role="button" data-toggle="" data-target="" title="Revive Goal '.$row1['title'].'" role="button"><small>Revive</small></a></td></tr>';
		}
	}
	?>
  </tbody>
...
if (!$count)
	{
		echo '<h3>No Goals With Past Deadline, thats good!</h3>';
