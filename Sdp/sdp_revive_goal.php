...
//php code to extract goal related data from goal_dead table
$Id = $_GET["id"]; // from previous page

$email=$_SESSION['user'][0];
$sql29="select * from goal_dead where email='$email'and goal_id='$Id'";
$res29=mysqli_query($GLOBALS["___mysqli_ston"], $sql29);
$count29=mysqli_num_rows($res29);
// Run the Query
//echo $Id;echo $count;
$data29 = mysqli_fetch_array($res29);
$title_r = $data29['title'];
$_SESSION['title_r'] = $title_r;


$goal_id_r = $data29['goal_id'];
$_SESSION['goal_id_r'] = $goal_id_r;
//echo "hi";
//echo $data29['action_plan'];
//php code to extract data from goal_dead table ends here
?>
	<!-- Favicon -->
    <link href="images/favicon.ico" rel="shortcut icon"/>
	
    <title>EYB | SDP | Revive Goal</title>
...
<div class="row">
  ...
  <!--<p class="navbar-brand">Welcome <?php echo $_SESSION['user'][1]; ?>,</p>-->
	<center><h2>Re-Enter Certain Fields And Revive the Goal</h2></center>
  	<form class="fieldset" method="post" action="sdp_revive_add.php">
  
  <div class="form-group">
    <label for="exampleInputPassword1">Title</label>
    <input type="text" name="title"class="form-control" id="disabledInput" placeholder="Title" required="" value="<?php echo $data29['title']?>" disabled>
  </div>
  <div class="form-group">
