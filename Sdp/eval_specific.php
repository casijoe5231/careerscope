...
$user_score= ($value5+$value7+1) * 2;
////Calculation for user entered data ends
echo 'hi';
...
$sql4="insert into goal_specific (goal_id,email,title,date_eval,goal_rate,justify,yesno,comment,user_score,sys_score,system_comment)values('$goal_id','$email','$row1[title]','$time_added','$value5','$justify','$value7','$comment','$user_score','$sys_score','$comment')";
