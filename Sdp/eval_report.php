...
<div class="panel panel-primary">
 ...
 // echo $goal_id;
  ...
  ?>
  <div class="panel-heading"><center><h4><?php echo "$user";echo "'s Submitted Weekly Reports for $row3[title]";?></h4></center></div>
...
$count=mysqli_num_rows($res1);
	if($count)
	{
		...
		{ ?>
			<tr><th scope="row"><?php echo $row1['sub_task']; ?> </th><td><?php echo $row1['goal_com']; ?> </td><td><?php echo $row1['time_added']; ?></td><td><?php echo '<a href="report_view.php?r_id='.$row1['report_id'].'" class="btn btn-info" role="button" data-toggle="modal" data-target="#myModal_View" title="View Report for '.$row1['sub_task'].'" role="button">View Report</a></td></tr>';?>
	<?php	}
	}
	else
	{
