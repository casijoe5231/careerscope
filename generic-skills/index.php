        ...
        <div class="row">
            <div class="col-sm-2">
                <div style="margin-top:20px;" class="list-group">
                    <a href="index.php" class="list-group-item active">Generic Skills</a>
                    <a href="../riasec/index.php" class="list-group-item ">EQ Test</a>
                    <a href="#" class="list-group-item">Social Quotient</a>
                    <a href="goal.php" class="list-group-item">SQ Test</a>
