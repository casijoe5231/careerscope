<?php
	...
	$sql="insert into user(fname, lname, email, class, branch, username, password, mod1, E, A, C, N, O ) values('$fname','$lname','$email','$class','$branch','$username','".md5($password)."',0,0,0,0,0,0)";
