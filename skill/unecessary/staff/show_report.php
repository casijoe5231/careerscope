...
<h3>Assessment Results</h3>
	...
	if( $num_rows==0)
	{
	   echo "<p style=\"text-align:center\">User does not seem to have received a review
	         <br>When user receives a review a report will be generated.</p><br>";
	}
...
<?php
	    ...
	    $sql="SELECT E,A,C,N,O FROM user WHERE mod1!=0";			
		...
		echo "User's assessment score compared to ".$num_users." participants";
...
<div class='grid' style="padding-left:5px;">
	<div class='grid_title' style="background-color:#E0FFFF; padding-left:-5px;">
...
// --------------------------------------------------------------------------------------------------------------------------
    ...
    {
		echo "<div class='grid'><div class='grid_title' style=\"background-color:#E6F2FF; color:#61666B;\">";
		echo "<div style=\" float:left; margin-right:5px; \"><img src='".$img_path."'></div>";
		echo "<h3>".$trait."</h3>".$description."</div>";
	
		echo "<br><h3 style=\"text-align:center;\">Your Score:</h3>";
			echo "<table><tr><h3> <th>Self Assessed</th> <th>Observer Assessed</th> </h3></tr>";
			echo "<tr><td>";
			$SP=($S/40)*100;
		    ...
		    echo "     <div class='progress'>
					   <span class='green' style=\"width: ".$SP."%;\"><span>".$SP."%</span></span>
					   </div>";
					
		    echo " <td><div class='progress'>
					   <span class='blue' style=\"width: ".$OBS_SP."%;\"><span>".$OBS_SP."%</span></span>
					   </div>";
			...
			echo "<br><br><table>";
			echo "<tr>";
			echo "<td><h3 style=\"text-align:center;\">Average Review:</h3></td>";
            echo "<td><h3 style=\"text-align:center;\">Observer Review</h3></td></tr>";
			$SP=($S/40)*100;
			$OBS_SP=($OBS_S/40)*100;
			$AVG_SP=($SP + $OBS_SP)/2;
        	...
        	echo " <div class='progress'>
					   <span class='orange' style=\"width: ".$AVG_SP."%;\"><span>".$AVG_SP."%</span></span>
					   </div>";
		echo "</div>";
		...
		echo "<td>";
		    echo "<div class='res'>";
			if( abs($SP-$OBS_SP) > 5 && abs($SP-$OBS_SP)<=15)
				echo "Your Observer assessment shows a slight difference over your personal assessment.
				       This means that your observers percieve you in the same way as you do 
 					  but in a slightly different way.";
			else if( abs($SP-$OBS_SP) > 15 && abs($SP-$OBS_SP)<=30)
				echo "Your Observer assessment shows a high difference over your personal assessment
				      This means that your observers percieve you in the same way as you do 
 					  but in a slightly different way.";
			else if( abs($SP-$OBS_SP) > 30 && abs($SP-$OBS_SP)<=50)
				echo "Your Observer assessment shows a very high difference over your personal assessment
				      This means that your observers may think of you as a completely different person than you do yourself.
					  This can help you to improve yourself.";
			else if( abs($SP-$OBS_SP) > 50)
				echo "Your Observer assessment completely differs over your personal assessment.
				      This means that your observers percieve you a completely different way than you do yourself.
					  Hence a improvement maybe be required in this aspect";	
			else
                echo "Your Self & Observer assessment show common values
				      This means that you percieve yourself in the same way as your observers do.
					  This also means that you understand yourself very well on this trait.";			
		    echo "</div>";
