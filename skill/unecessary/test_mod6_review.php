...
<?php
$user=$_GET['userss'];
echo "<form action='test_mod6_review.php?userss=".$user."' method='POST'>";
?>
    <table cellpadding="5">
	<tr><td>Select:
...
<br><br><a href='test_mod6.php' style="border:1px solid #09F; background:#09F; padding:5px; color:#FFF;  border-radius:5px;">Continue</a>
</p>
<br>
