...
echo "<br><br>";
echo "<form action='test_mod2_review.php?users=".$user."' method='POST' onsubmit=\"JavaScript:return validate_radiobutton_group();\">";
...
<a href="test_mod2.php" style="border:1px solid #09F; background:#09F; padding:5px; color:#FFF;  border-radius:5px; float:right; margin-right:25px;">< Back</a>
</div>
