...
//Get Result for database for current user
	...
	echo "<a href='result1.php'>Score based report</a><br>";
	echo "<a href='result2.php'>Detailed report</a>";
...
<br>
<h3>Assessment Results are as follows:</h3>
...
<div class='grid' style="padding-left:5px;">
	<div class='grid_title' style="background-color:#CCE6FF; padding-left:-5px;">
...
// --------------------------------------------------------------------------------------------------------------------------
    ...
    {
		echo "<div class='grid'><div class='grid_title' style=\"background-color:#CCE6FF;\">";
