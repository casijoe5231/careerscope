<?php
	...
	$sql="insert into activity(email,menu_accessed,timesql) values('$emaill','HOD/Mentor Observer Assessment','$timesql')";
...
$email=$_SESSION['hod'][0];
		 ...
		 {		 
			 ...
			 else
			 {
				...
				echo "<a href='test_mod3_rate.php?userss=".$row['requestor']."'>";
