...
<?php
$user=$_GET['users'];
echo "<form action='test_mod2_review.php?users=".$user."' method='POST'>";
?>
    <table cellpadding="5">
	<tr><td>Select:
...
<br><br><a href='test_mod2.php' style="border:1px solid #09F; background:#09F; padding:5px; color:#FFF;  border-radius:5px;">Continue</a>
</p>
<br>
