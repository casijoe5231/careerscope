...
<?php
	if (strpos($_SERVER['HTTP_REFERER'],'test_mod3.php') == true) // Check for valid referrer
	{
    // echo "<br><p style='color:green;'>Referrer Valid</p>";
    }
	else
	{
	 header("Location: test_mod3.php"); //If referrer is invalid redirect to test 2 main page.
     die();
	}
	if(!isset($_SESSION['hod']))
	{
...
echo "<br><br>";
echo "<form action='test_mod3_review.php?userss=".$user."' method='POST' onsubmit=\"JavaScript:return validate_radiobutton_group();\">";
...
<a href="test_mod3.php" style="border:1px solid #09F; background:#09F; padding:5px; color:#FFF;  border-radius:5px; float:right; margin-right:25px;">< Back</a>
</div>
