...
<!--  Welcome Bar  -->
        <nav class="navbar-container">
            <ul class="nav nav-pills navbar-left">
                <p class="navbar-brand">Welcome <?php echo $_SESSION['user'][1]; ?>,  
...
<!--  /Welcome Bar  -->
        ...
        <tr>
        <th><b></b></th>
        <th><b>SECOND YEAR</b></th>
        <th><b>THIRED YEAR</b></th>
        <th><b>BE</b></th>
		...
		include 'includes/connection1.php';
		 $email=$_POST['email1'];
		$sql2="select * from asubhod where email='$email'";
		 $res1=mysqli_query($GLOBALS["___mysqli_ston"], $sql2);
        while($row1=mysqli_fetch_array($res1))
        {
