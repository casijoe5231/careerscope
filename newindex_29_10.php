...
//$rand = 0;
		if($count)
		{
			while($row1=mysqli_fetch_array($res1))
			{
				...
				if(($row1['time_completed'])=== '0000-00-00 00:00:00')
				{
					echo '<div class="container"><!-- Trigger the modal with a button --><!-- Modal --><div class="modal fade" id="myModal69" role="dialog"><div class="modal-dialog"><!-- Modal content--><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-confirmation">GOAL REMINDER</h4></div><div class="modal-body"><p class="danger">'.$row1['title'].'<br> Deadline: '.$row1['deadline'].'</p></div><div class="modal-footer"><button type="button" class="btn btn-danger" id="close" data-dismiss="modal">Close</button><a href="Sdp/sdp_edit.php" class="btn btn-info" role="button">View Goals</a></div></div></div></div></div>';
