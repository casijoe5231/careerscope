...
<table border="0" align="center">
    ...
    <tr> 
    	 <td width="200"><?php include("imenu.php"); ?></td>
    	 <div id="account"><td> 
  ...
  <fieldset style="width:600"> 
   ...
   <table border="0" cellspacing="4" cellpadding="4" width="600" class="register" align="center">
     ...
     <tr> 
       <td><label for="MiddleName">Name:</label></td>
       <td><input name="MiddleName" type="Text" id="MiddleName" value="<?php echo $MiddleName; ?>"></td>
         
     </tr>

     <tr> 
       <td><label for="LastName">Father's Name:</label></td>
     ...
     <tr> 
       ...
       <td><textarea name="permAddress1" id ="permAddress1"><?php echo $permAddress1; ?></textarea></td>   
     </tr>
  ...
  <option value="Pondicherry">Pondicherry</option> 
     ...
     <tr> 
       ...
       <td><input type="text" name="date1" id="sel3" size="20" value="<?php echo $date1; ?>"><input type="reset" value="..." onClick="return showCalendar('sel3', '%Y/%m/%d');"><div id="display" style="float: right; clear: both;"></div> </td>
     </tr>
