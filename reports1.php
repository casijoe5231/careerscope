...
<tr>
<td colspan="2"><label><span style='color:red;'>*</span><strong>Select name of student:</strong></label></td>
...
<?php
  $sql1="select distinct name as name,email from approve_mentor where mname='$name' and status=1";
