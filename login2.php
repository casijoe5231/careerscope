...
<?php
	if(isset($_GET['login'])){
		if($_GET['login']==0){
			echo '<div style="margin-top:80px;width:98%;border-style:solid;border-width:2px;border-radius:5px;border-color:#222;">';
			echo '<h3 style="text-align:center;">You need to be logged in first</h3>';
			echo '</div>';
		}
	}
