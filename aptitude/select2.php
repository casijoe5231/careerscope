                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-8">
                                    <h4 style="padding-top:10px;" class="text-center">Low/Modrate </h4>
                                </div>
                            </div>
                            <div class="panel-footer">
                                <a class="btn btn-default btn-block" href='select.php?type=quant'>Go!</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-8">
                                    <h4 style="padding-top:10px;" class="text-center">High Level</h4>
                                </div>
                            </div>
                            <div class="panel-footer">
                                <a class="btn btn-default btn-block" href='select.php?type=high'>Go!</a>
                            </div>
                        </div>
                    </div>
                     </div>
