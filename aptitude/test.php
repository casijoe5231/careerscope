                ...
                while($row = mysqli_fetch_array($res))
                {
                   ...
                   /* if($row['q_id']==$q_id)
                    ...
                    echo'
                                            ...
                                            <h4>Choose the serial number of the figure below which should come in the series to complete the pattern</h4>
                                            <div class="row">
                                                <div class="col-sm-offset-2 col-sm-8">
                ...
                <div class="row downLine">
                    <div class="col-md-12 text-right">
                        ...
                        <div class="col-md-6 text-right dm">
                            <ul id="downMenu">
                                            <li><a href="../newindex.php"data-toggle="tooltip" title="Home Page" >Home</a></li>
                                            <li><a href="#" target="_blank">E Portfolio</a></li>
                                            <li><a href="index.php" target="_blank" data-toggle="tooltip" title="Aptitude Test!">Aptitude Test</a></li>
                                            <li><a href="../skill/" target="_blank">Psychometric Test</a></li>
