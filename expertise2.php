<?php
	...
	$sql="insert into activity(email,menu_accessed,timesql) values('$emails','Testmgr Add Area of Expertise','$timesql')";
...
<h3>&nbsp; Test Manager menu</h3>
</div>
<br>
<br>
<div style="float:left;clear:both;margin-top:30px;">
<ul id="sidenavigation" class="MenuBarVertical">
	<li><a href="expertise2.php">Area of expertise</a></li>
	<li><a href="testmgrindex.php">Back to home</a></li>
	</ul>
</div>
<!-- Content here -->
...
echo "<SCRIPT LANGUAGE='JavaScript'>
    ...
    window.location.href='expertise1.php';
});</SCRIPT>";
}
