...
<?php
	...
	echo "<form name='TestForm' action='result1.php' method='POST'>";
		...
		echo "<div class='question'><b style=\" color:white;\">Problem Figures</b>";
			?>
			<br><br><img src="<?php echo $row1['question'] ?>">
			<?php
    ...
    echo "<input type='hidden' name='t_id' value='".$_GET['id']."'>";
      $q_index=1;
		while($row = mysqli_fetch_array($res))
		{
			...
			echo "<div class='question'><b style=\" color:white;\">Answer Figures</b>";
			if($row['q_id']==$q_id)
			{
			...
			?>
			<br><br>
			<b>Choose the serial number of the figure below which should come in the series to complete the pattern:</b><br><img src="<?php echo $row['question'] ?>"></div>
			<?php
