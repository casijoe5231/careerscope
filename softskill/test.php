...
<h3 class="text-center">Test Questions</h3>
		   ...
		   <table class="table table-bordered" id="details"  style="margin-top:20px;margin-bottom:20px;">
        <thead>
        <tr>
		 <th><b>Questions no.</b></th>
        <th><b>Questions</b></th>
		  <th><b>Almost Never</b></th>
			<th><b>Very Rarely</b></th>
         <th><b>Sometimes</b></th>
       <th><b>Mostly</b></th>
...
{   
    ...
    if ($_GET['type']==0) {
        $sql="SELECT * FROM softskillquestions WHERE t_id='$_GET[id]'";
    $res=mysqli_query($GLOBALS["___mysqli_ston"], $sql);
    $q_total=mysqli_num_rows($res);
            ...
            echo'
                                    ...
                                    <div class="form-group">
										...
										<div class="radio radio-danger ">
                                              ...
                                              <input value="1" type="radio" id="radio'.++$i.'"name="radio'.$q_index.'" >   <label for="radio'.$i.'">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-1 col-sm-11">
                                          <div class="radio radio-danger ">
										      ...
										      <input value="2" type="radio" id="radio'.++$i.'" name="radio'.$q_index.'">  <label for="radio'.$i.'">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-1 col-sm-11">
                                          <div class="radio radio-danger ">
                                              <input value="3" type="radio" id="radio'.++$i.'"name="radio'.$q_index.'" ><label for="radio'.$i.'">
									...
									<div class="form-group">
                                        <div class="col-sm-offset-1 col-sm-11">
                                          <div class="radio radio-danger ">
                                              ...
                                              <input value="4" type="radio" id="radio'.++$i.'" name="radio'.$q_index.'"><label for="radio'.$i.'">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-1 col-sm-11">
                                          <div class="radio radio-danger ">
                                              ...
                                              <input value="5" type="radio" id="radio'.++$i.'"name="radio'.$q_index.'" ><label for="radio'.$i.'">
