...
$discipline1 = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_SESSION['discipline1']);
...
$year1 = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_POST['year']);
...
$sql="insert into masteruser(email,password,name,mobile,role,discipline,institute,branch,date,status) values('$email','$password','$name','$phone','Alumni','$discipline1','$institute1','$branch','".date('d/m/Y')."',0)";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");

$sql="insert into ialumni(email,gender,dob,address,year,company,title,experience,expertype,area,enrollstatus,paymentstatus) values('$email1','$gender','$date','$address','$year1','$company','$title','$experience','$expertype','$area',0,0)";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");
...
*/
	...
	else
	{
		...
		window.location.href='stregister.php';
		});</SCRIPT>";
	}
}
