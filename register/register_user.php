<?php
	...
	$sql="insert into user(fname, lname, email, class, branch, username, password,type, mod1, E, A, C, N, O ) values('$fname','$lname','$email','$class','$branch','$username','$password','$type',0,0,0,0,0,0)";
