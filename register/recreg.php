...
$discipline3 = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_SESSION['discipline3']);
$institute3 = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_SESSION['institute3']);
...
$sql="insert into masteruser(email,password,name,mobile,role,discipline,institute,branch,date,status) values('$email','$password','$name','$phone','Recruiter','$discipline3','$institute3','$branch','".date('d/m/Y')."',0)";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");

$sql="insert into irecruiter(email,designation,company,comments,enrollstatus,paymentstatus) values('$email1','$designation','$company','$comments',0,0)";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $sql)or die("query not executed");
...
*/
	...
	if($res)
	{
		...
		<link rel='stylesheet' href='../css/alertify.default.css' /></head></html>";
		echo "<SCRIPT LANGUAGE='JavaScript'>
		alertify.alert('You have registered successfully.<br>An email is sent to the TPO.<br>Please login', function (e) {
		window.location.href='../login.php';
		});</SCRIPT>";
	}
	else
	{
		...
		window.location.href='recregister.php';
		});</SCRIPT>";
	}
