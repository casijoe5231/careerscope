...
$sql="insert into masteruser(email,password,name,mobile,role,discipline,institute,branch,date,status) values('$email','$password','$name','$phone','TPO','$discipline4','$institute4','none','".date('d/m/Y')."',0)";
