...
$pdf->SetFont('Times','',14);
	...
	$text2= "<br><b>Test Name: </b>".$test_name;
	$text3= "<br><b>Subject Name: </b>".$subject_name."<br><br>";
...
$pdf->Cell(40,5,'Attempts',1,1,'C',0);
...
while($row=mysqli_fetch_array($res))
	{
		...
		$pdf->Cell(60,5,$row2['fname']." ".$row2['lname'],1,0,'C',0);
		$pdf->Cell(40,5,$row['score'],1,0,'C',0);
		$pdf->Cell(40,5,$row['max_score'],1,0,'C',0);
		$pdf->Cell(40,5,$row['attempt'],1,1,'C',0);
